            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="../catalogue/compositeurs.php">Compositeurs</a></li>
                        <li><a href="../catalogue/albums.php">Albums</a></li>
                        <li><a href="../catalogue/enregistrements.php">Enregistrements</a></li>
                    </ul>
                </li>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p>To see the difference between static and fixed top navbars, just scroll.hh</p>
        <p>
